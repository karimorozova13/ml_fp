...
clf4 = MLPClassifier(hidden_layer_sizes=(50,), max_iter=500)

estimators = [('lr', clf1), ('rf', clf2), ('svc', clf3), ('mlp', clf4)]

final_estimator = GradientBoostingClassifier(subsample=0.75, max_features='sqrt', random_state=42)

mod_stk_clf = StackingClassifier(estimators=estimators, final_estimator=final_estimator)
